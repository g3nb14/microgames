# 🧠 MicroGames | Brain Training Arsenal
...
1. **Memory Match 🧠** - Find the matching emoji pairs. Keep your moves to a minimum!
2. **15 Puzzle 🧩** - The classic sliding number puzzle.
3. **Catch 👾 Avoid 💣** - Whack-a-mole style reaction test. Don't hit the bombs!
4. **Simon Says 🎨** - Memorize and repeat the growing color sequence.
5. **Color Clash 🌈** - A Stroop effect test. Does the word match its text color?
6. **Shape Clash 🔺** - Don't let your brain trick you. Does the word match the drawn shape?
7. **Chimp Test 🐒** - Memorize the numbers and click them in order after they hide.
8. **Schulte Table 🔢** - Expand your peripheral vision. Find numbers 1-25 as fast as possible.
9. **Pattern Memory 🧩** - Memorize the grid pattern. It grows larger as you progress!
